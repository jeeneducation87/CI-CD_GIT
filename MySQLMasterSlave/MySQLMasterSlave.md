...
Есть лавный сервер (Master), который принимает все изменения в БД. Есть один или несколько подчиненных серверов (Slave), которые получают изменения от мастера и применяют их у себя.
